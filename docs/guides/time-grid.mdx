...
timed columns and stack in a lane above the grid. On React Native the lane shows
the active page's days, like the day header, and stays pinned above the grid while
you scroll the hours. Turn it off with `showAllDayEventCell={false}`.
