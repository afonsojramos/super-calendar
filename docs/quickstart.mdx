...
<Steps>
  <Step title="Add the package and peers">
    <CodeGroup>
    ```bash npm
    npx expo install react-native-bigger-calendar react-native-reanimated react-native-gesture-handler react-native-worklets @legendapp/list date-fns
    ```

    ```bash pnpm
    pnpm add react-native-bigger-calendar react-native-reanimated react-native-gesture-handler react-native-worklets @legendapp/list date-fns
    ```
    </CodeGroup>
