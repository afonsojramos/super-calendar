...
| `weekdayFormat` | `narrow \| short \| long` | Month weekday header width (default `short`).     |
...
<CardGroup cols={2}>
  <Card title="Components">
    `Calendar`, `Agenda`, `MonthView`, `MonthPager`, `MonthList`, `TimeGrid`, `ResourceTimeline`,
    `DefaultEvent`, `DefaultMonthEvent`
  </Card>
  ...
  <Card title="Helpers">
    ...
    `isWeekend`, `isSameCalendarDay`, `minutesIntoDay`, `weekdayFormatToken`, `DEFAULT_HOUR_HEIGHT`
  </Card>
  <Card title="Types">
